...
export interface AidRequest {
  ...
  jobRole: string;           // Alteração 3: Cargo
  eventName: string;
  eventLocation: string;
  eventDate: string;
  registrationValue: string; // Alteração 4: Valor
  eventParamsText?: string;
  modality: Modality;
  status: RequestStatus;
  submissionDate: string;
  
  // Alteração 9: Aprovações Duplas
  scientificApproved?: boolean;
  adminApproved?: boolean;

  documents: SimpleFile[];
  ethicsCommitteeProof?: SimpleFile; // Alteração 8
...
const EmployeeDashboard: React.FC<EmployeeDashboardProps> = ({ requests, employeeId, onRequestSubmit, onAccountabilitySubmit }) => {
  ...
  const RequestForm = () => {
    const [formData, setFormData] = useState({ 
      employeeInputName: '', 
      jobRole: '', // Alteração 3: Campo cargo
      eventName: '', 
      eventLocation: '', 
      eventDate: '', 
      registrationValue: '', // Alteração 4: Campo valor
      modality: Modality.I, 
      eventParamsType: 'TEXT' as 'TEXT' | 'FILE', 
      eventParamsText: '', 
      summaryFile: null as SimpleFile | null, 
      paramsFile: null as SimpleFile | null,
      ethicsFile: null as SimpleFile | null // Alteração 8: Ética
    });
    ...
    // Alteração 6: Validação de requisitos de submissão
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        ...
        {/* Alteração 11: MODALIDADE SELECTION CARDS - TOPO */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div>
                    {/* Alteração 2: Label e UI de Data */}
                    <label className="block text-xs font-medium text-gray-700 mb-1 ml-1">Data limite de submissão</label>
              ...
              {/* Alteração 5: FORMATO SUBMISSÃO TEXTOS */}
              ...
              {/* Alteração 7: RESUMO SUBMISSÃO LABEL */}
              ...
              {/* Alteração 8: MODALIDADE II - ÉTICA */}
  ...
  const AccountabilityView = () => {
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-4xl mx-auto">
        ...
        {/* Alteração 13: LISTA DE REEMBOLSÁVEIS */}
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto p-6 relative">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 pt-4 border-t items-center flex-wrap">
                ...
                {/* Alteração 10: Botão de Confirmar Pagamento */}
